...
const bodyClassByMode: Record<LocalDeliveryStatsLayoutMode, string> = {
  wide: 'grid grid-cols-[minmax(420px,1.8fr)_minmax(320px,1.1fr)_minmax(160px,0.8fr)] items-start gap-4',
  medium: 'grid grid-cols-[minmax(420px,1fr)_minmax(160px,0.42fr)] grid-rows-[auto_auto] items-start gap-4',
    ...
    <AnimatePresence mode="wait" initial={false}>
      {hidden ? (
        ...
        <motion.div
          ...
          className="pointer-events-none w-full px-4 pb-4 pt-10"
          style={{ background: LOCAL_DELIVERY_STATS_OVERLAY_GRADIENT }}
        >
          <div className="pointer-events-auto max-h-[42vh] overflow-y-auto scroll-thin pr-1">
