...
import { PrintTemplateChannelPage } from '@/featuresV2/templates/printDocument/pages/PrintTemplateChannelPage'
import { PrintTemplateConfigPage } from '@/featuresV2/templates/printDocument/pages/PrintTemplateConfigPage'
