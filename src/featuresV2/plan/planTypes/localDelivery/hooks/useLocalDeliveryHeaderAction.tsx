...
import { useRouteSolutionMutations } from './routeSolution/useRouteSolutionMutations'
...
export const useLocalDeliveryHeaderAction = ({ localDeliveryPlanId, planId}: Props) => {
  ...
  const routeRedyForDelivery = async ()=>{
    if(!planId) return
    routeReadyForDelivery(planId)
  }
