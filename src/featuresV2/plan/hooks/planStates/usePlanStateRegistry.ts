...
import { useDeliveryPlanState } from '../../store/planStateStore'


import type { DeliveryPlanState, PlanStates } from '../../types/planState'
...
export const usePlanStateRegistry = () => {
  const states = useDeliveryPlanState()

  return useMemo(
    () => createPlanStateRegistry(states),
    [states],
  )
}
